...
/** أيقونات SVG خطية (بأسلوب Lucide) بدون مكتبات خارجية */
const ICONS: Record<string, string> = {
  sparkles:
    '<path d="M9.94 14.34 12 20l2.06-5.66L20 12l-5.94-2.34L12 4 9.94 9.66 4 12z"/><path d="M5 3v4"/><path d="M19 17v4"/><path d="M3 5h4"/><path d="M17 19h4"/>',
  'thumbs-up':
...
export function Icon({ name, size = 20, strokeWidth = 2, className = '', style }: { name: IconName; size?: number; strokeWidth?: number; className?: string; style?: CSSProperties }) {
  return (
    <svg
      width={size}
      height={size}
